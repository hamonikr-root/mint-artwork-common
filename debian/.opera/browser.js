// 
/**
...
(function(opera){
	...
	var bjsversion=' Opera Desktop 11.10 core 2.8.131, April 26, 2011 ';
...
// TinyMCE double IFRAME init problem, some versions
	...
	if((hostname.indexOf('tokyo.jp')>-1)||(hostname.indexOf('lg.jp')>-1)){			// PATCH-186, tokyo.jp, lg.jp enable maps
		...
		if(hostname.indexOf('docs.google.com')>-1){			// PATCH-402, Work around compilation bug by reversing the order of two statements
			addPreprocessHandler(/(;this\.[A-z]{1,2}=this\.[A-z]{1,2}=this\.[A-z]{1,2}=this\.[A-z]{1,2}=!1)(;this\.[A-z]{1,2}=\[\])/g,'$2$1');
				if(self==top)postError.call(opera, 'Opera has modified the JavaScript on '+hostname+' (Work around compilation bug by reversing the order of two statements). See browser.js for details');
		}
		...
		addCssToDocument('ul#topnav li div.topnav-dd-outer{margin-left: auto !important}');
				// PATCH-400, Make sure events can reach FBI menu
		addCssToDocument('#portal-logo {margin-top: -2em !important;}');
			if(self==top)postError.call(opera, 'Opera has modified the JavaScript on '+hostname+' (Avoid scrollbar on FBI\nMake sure events can reach FBI menu). See browser.js for details');
